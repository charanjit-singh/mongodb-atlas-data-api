 ...
 * 
 * @export
 * @interface UpdateMany200Response1
 */
export interface UpdateMany200Response1 {
    /**
     * 
     * @type {object}
     * @memberof UpdateMany200Response1
     */
    matchedCount: object;
    /**
     * 
...
/**
 * Check if a given object implements the UpdateMany200Response1 interface.
 */
export function instanceOfUpdateMany200Response1(value: object): boolean {
    if (!('matchedCount' in value)) return false;
    if (!('modifiedCount' in value)) return false;
    return true;
}

export function UpdateMany200Response1FromJSON(json: any): UpdateMany200Response1 {
    return UpdateMany200Response1FromJSONTyped(json, false);
}

export function UpdateMany200Response1FromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateMany200Response1 {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateMany200Response1ToJSON(value?: UpdateMany200Response1 | null): any {
    if (value == null) {
        return value;
    }
    return {
