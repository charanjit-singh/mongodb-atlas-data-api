 ...
 * 
 * @export
 * @interface UpdateOne200Response
 */
export interface UpdateOne200Response {
    /**
     * 
     * @type {number}
     * @memberof UpdateOne200Response
     */
    matchedCount: number;
    /**
     * 
...
/**
 * Check if a given object implements the UpdateOne200Response interface.
 */
export function instanceOfUpdateOne200Response(value: object): boolean {
    if (!('matchedCount' in value)) return false;
    if (!('modifiedCount' in value)) return false;
    return true;
}

export function UpdateOne200ResponseFromJSON(json: any): UpdateOne200Response {
    return UpdateOne200ResponseFromJSONTyped(json, false);
}

export function UpdateOne200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateOne200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateOne200ResponseToJSON(value?: UpdateOne200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
