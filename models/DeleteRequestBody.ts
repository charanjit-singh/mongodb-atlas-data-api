...
/**
 * Check if a given object implements the DeleteRequestBody interface.
 */
export function instanceOfDeleteRequestBody(value: object): boolean {
...
export function DeleteRequestBodyFromJSON(json: any): DeleteRequestBody {
  return DeleteRequestBodyFromJSONTyped(json, false);
}

export function DeleteRequestBodyFromJSONTyped(
  json: any,
...
export function DeleteRequestBodyToJSON(value?: DeleteRequestBody | null): any {
  if (value == null) {
    return value;
  }
  return {
