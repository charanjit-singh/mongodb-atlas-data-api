 ...
 * 
 * @export
 * @interface UpdateMany200Response
 */
export interface UpdateMany200Response {
    /**
     * 
     * @type {number}
     * @memberof UpdateMany200Response
     */
    matchedCount: number;
    /**
     * 
...
/**
 * Check if a given object implements the UpdateMany200Response interface.
 */
export function instanceOfUpdateMany200Response(value: object): boolean {
    if (!('matchedCount' in value)) return false;
    if (!('modifiedCount' in value)) return false;
    return true;
}

export function UpdateMany200ResponseFromJSON(json: any): UpdateMany200Response {
    return UpdateMany200ResponseFromJSONTyped(json, false);
}

export function UpdateMany200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateMany200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateMany200ResponseToJSON(value?: UpdateMany200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
