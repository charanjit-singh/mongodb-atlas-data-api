 ...
 * 
 * @export
 * @interface InsertMany200Response1
 */
export interface InsertMany200Response1 {
    /**
     * 
     * @type {Array<object>}
     * @memberof InsertMany200Response1
     */
    insertedIds?: Array<object>;
}

/**
 * Check if a given object implements the InsertMany200Response1 interface.
 */
export function instanceOfInsertMany200Response1(value: object): boolean {
    return true;
}

export function InsertMany200Response1FromJSON(json: any): InsertMany200Response1 {
    return InsertMany200Response1FromJSONTyped(json, false);
}

export function InsertMany200Response1FromJSONTyped(json: any, ignoreDiscriminator: boolean): InsertMany200Response1 {
    if (json == null) {
        return json;
    }
    return {
...
export function InsertMany200Response1ToJSON(value?: InsertMany200Response1 | null): any {
    if (value == null) {
        return value;
    }
    return {
