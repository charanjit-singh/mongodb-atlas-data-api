 ...
 *
 * @export
 * @interface InsertManyRequestBody
 */
export interface InsertManyRequestBody {
  /**
   ...
   *
   * @type {string}
   * @memberof InsertManyRequestBody
   */
  dataSource?: string;
  /**
...
/**
 * Check if a given object implements the InsertManyRequestBody interface.
 */
export function instanceOfInsertManyRequestBody(value: object): boolean {
...
export function InsertManyRequestBodyFromJSON(
  json: any
): InsertManyRequestBody {
  return InsertManyRequestBodyFromJSONTyped(json, false);
}

export function InsertManyRequestBodyFromJSONTyped(
  json: any,
...
export function InsertManyRequestBodyToJSON(
  value?: InsertManyRequestBody | null
): any {
  if (value == null) {
    return value;
  }
