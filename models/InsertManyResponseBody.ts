 ...
 * @export
 * @interface InsertManyResponseBody
 */
export interface InsertManyResponseBody {
    /**
     * A list of the `_id` values of the inserted documents.
     * @type {Array<string>}
     * @memberof InsertManyResponseBody
     */
    insertedIds?: Array<string>;
}

/**
 * Check if a given object implements the InsertManyResponseBody interface.
 */
export function instanceOfInsertManyResponseBody(value: object): boolean {
    return true;
}

export function InsertManyResponseBodyFromJSON(json: any): InsertManyResponseBody {
    return InsertManyResponseBodyFromJSONTyped(json, false);
}

export function InsertManyResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): InsertManyResponseBody {
    if (json == null) {
        return json;
    }
    return {
...
export function InsertManyResponseBodyToJSON(value?: InsertManyResponseBody | null): any {
    if (value == null) {
        return value;
    }
    return {
