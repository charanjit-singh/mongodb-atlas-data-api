 ...
 * 
 * @export
 * @interface DeleteOne200Response
 */
export interface DeleteOne200Response {
    /**
     * 
     * @type {number}
     * @memberof DeleteOne200Response
     */
    deletedCount: number;
}

/**
 * Check if a given object implements the DeleteOne200Response interface.
 */
export function instanceOfDeleteOne200Response(value: object): boolean {
    if (!('deletedCount' in value)) return false;
    return true;
}

export function DeleteOne200ResponseFromJSON(json: any): DeleteOne200Response {
    return DeleteOne200ResponseFromJSONTyped(json, false);
}

export function DeleteOne200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteOne200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function DeleteOne200ResponseToJSON(value?: DeleteOne200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
