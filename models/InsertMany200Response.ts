 ...
 * 
 * @export
 * @interface InsertMany200Response
 */
export interface InsertMany200Response {
    /**
     * 
     * @type {Array<string>}
     * @memberof InsertMany200Response
     */
    insertedIds?: Array<string>;
}

/**
 * Check if a given object implements the InsertMany200Response interface.
 */
export function instanceOfInsertMany200Response(value: object): boolean {
    return true;
}

export function InsertMany200ResponseFromJSON(json: any): InsertMany200Response {
    return InsertMany200ResponseFromJSONTyped(json, false);
}

export function InsertMany200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InsertMany200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function InsertMany200ResponseToJSON(value?: InsertMany200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
