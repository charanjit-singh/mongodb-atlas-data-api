...
/**
 * Check if a given object implements the AggregateRequestBody interface.
 */
export function instanceOfAggregateRequestBody(value: object): boolean {
...
export function AggregateRequestBodyFromJSON(json: any): AggregateRequestBody {
  return AggregateRequestBodyFromJSONTyped(json, false);
}

export function AggregateRequestBodyFromJSONTyped(
  json: any,
...
export function AggregateRequestBodyToJSON(
  value?: AggregateRequestBody | null
): any {
  if (value == null) {
    return value;
  }
