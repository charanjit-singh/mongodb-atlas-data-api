 ...
 * 
 * @export
 * @interface DeleteMany200Response1
 */
export interface DeleteMany200Response1 {
    /**
     * 
     * @type {object}
     * @memberof DeleteMany200Response1
     */
    deletedCount: object;
}

/**
 * Check if a given object implements the DeleteMany200Response1 interface.
 */
export function instanceOfDeleteMany200Response1(value: object): boolean {
    if (!('deletedCount' in value)) return false;
    return true;
}

export function DeleteMany200Response1FromJSON(json: any): DeleteMany200Response1 {
    return DeleteMany200Response1FromJSONTyped(json, false);
}

export function DeleteMany200Response1FromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteMany200Response1 {
    if (json == null) {
        return json;
    }
    return {
...
export function DeleteMany200Response1ToJSON(value?: DeleteMany200Response1 | null): any {
    if (value == null) {
        return value;
    }
    return {
