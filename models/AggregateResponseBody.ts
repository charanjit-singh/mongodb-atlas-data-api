...
export interface AggregateResponseBody {
     ...
     * @type {Array<object>}
     * @memberof AggregateResponseBody
     */
    documents: Array<object>;
}

/**
 * Check if a given object implements the AggregateResponseBody interface.
 */
export function instanceOfAggregateResponseBody(value: object): boolean {
    if (!('documents' in value)) return false;
    return true;
}

export function AggregateResponseBodyFromJSON(json: any): AggregateResponseBody {
    return AggregateResponseBodyFromJSONTyped(json, false);
}

export function AggregateResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): AggregateResponseBody {
    if (json == null) {
        return json;
    }
    return {
...
export function AggregateResponseBodyToJSON(value?: AggregateResponseBody | null): any {
    if (value == null) {
        return value;
    }
    return {
