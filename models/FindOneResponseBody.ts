...
/**
 * The result of a findOne operation.
 * @export
 * @interface FindOneResponseBody
 */
export interface FindOneResponseBody {
    /**
     * A document that matches the specified filter. If no documents match, this is `null`.
     * @type {object}
     * @memberof FindOneResponseBody
     */
    document?: object;
}

/**
 * Check if a given object implements the FindOneResponseBody interface.
 */
export function instanceOfFindOneResponseBody(value: object): boolean {
    return true;
}

export function FindOneResponseBodyFromJSON(json: any): FindOneResponseBody {
    return FindOneResponseBodyFromJSONTyped(json, false);
}

export function FindOneResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): FindOneResponseBody {
    if (json == null) {
        return json;
    }
    return {
...
export function FindOneResponseBodyToJSON(value?: FindOneResponseBody | null): any {
    if (value == null) {
        return value;
    }
    return {
