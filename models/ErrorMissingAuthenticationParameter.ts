...
/**
* Indicates that an authentication parameter is missing from the request body or headers. For example, the request might include an `email` header but no corresponding `password` header.
*/
export class ErrorMissingAuthenticationParameter {
    'error'?: any | null;
    'errorCode'?: any | null;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return ErrorMissingAuthenticationParameter.attributeTypeMap;
    }
