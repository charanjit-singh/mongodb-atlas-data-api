...
export interface DeleteResponseBody {
     ...
     * 
     * @type {any}
     * @memberof DeleteResponseBody
     */
    deletedCount: any | null;
}

/**
 * Check if a given object implements the DeleteResponseBody interface.
 */
export function instanceOfDeleteResponseBody(value: object): boolean {
    if (!('deletedCount' in value)) return false;
    return true;
}

export function DeleteResponseBodyFromJSON(json: any): DeleteResponseBody {
    return DeleteResponseBodyFromJSONTyped(json, false);
}

export function DeleteResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteResponseBody {
    if (json == null) {
        return json;
    }
    return {
...
export function DeleteResponseBodyToJSON(value?: DeleteResponseBody | null): any {
    if (value == null) {
        return value;
    }
    return {
