 ...
 * credentials.
 * @export
 * @interface ErrorNoAuthenticationSpecified
 */
export interface ErrorNoAuthenticationSpecified {
    /**
     * 
     * @type {any}
     * @memberof ErrorNoAuthenticationSpecified
     */
    error?: any;
    /**
     * 
...
/**
 * Check if a given object implements the ErrorNoAuthenticationSpecified interface.
 */
export function instanceOfErrorNoAuthenticationSpecified(value: object): boolean {
    return true;
}

export function ErrorNoAuthenticationSpecifiedFromJSON(json: any): ErrorNoAuthenticationSpecified {
    return ErrorNoAuthenticationSpecifiedFromJSONTyped(json, false);
}

export function ErrorNoAuthenticationSpecifiedFromJSONTyped(json: any, ignoreDiscriminator: boolean): ErrorNoAuthenticationSpecified {
    if (json == null) {
        return json;
    }
    return {
...
export function ErrorNoAuthenticationSpecifiedToJSON(value?: ErrorNoAuthenticationSpecified | null): any {
    if (value == null) {
        return value;
    }
    return {
